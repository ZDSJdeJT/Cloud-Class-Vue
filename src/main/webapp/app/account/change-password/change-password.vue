...
<!--             <div v-if="$v.resetPassword.currentPassword.$anyDirty && $v.resetPassword.currentPassword.$invalid">
          ...
          <b-modal ref="firstLoginChangePassword" id="firstLoginChangePassword" title="firstLoginChangePassword" v-bind:title="$t('firstLoginChangePasswordTitle')">
            <div class="modal-body">
              <p id="jhi-logout-user-heading" v-text="$t('firstLoginChangePasswordMessage')">
                Are you sure you want to refresh?
              </p>
            </div>
            <div slot="modal-footer">
              <button type="button" class="btn btn-primary" id="confirm-logout-user" v-text="$t('sure')" v-on:click="closeDialog()">
                Refresh
              </button>
            </div>
          </b-modal>
